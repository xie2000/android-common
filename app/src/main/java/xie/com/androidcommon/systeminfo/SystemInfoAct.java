...
public class SystemInfoAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sb.append("手机型号：" + DeviceInfoUtils.getHandsetType() + "\n");
        sb.append("SDK版本：" + DeviceInfoUtils.getPhoneSDKVersionChar() + "(" + DeviceInfoUtils.getPhoneSdkVersion() + ")\n");
        sb.append("IMEI:" + DeviceInfoUtils.getIMEI() + "\n");
